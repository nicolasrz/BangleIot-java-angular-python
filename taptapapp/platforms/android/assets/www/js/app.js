...
app.controller('MainCtrl', function($scope, $http, $location){
	...
	$scope.connection = function(){
		...
		$http({
		  method: 'GET',
		  url: 'http://149.202.62.129:8080/person/search/findByFirstnameAndLastname?firstname='+firstname+'&lastname='+lastname
...
app.controller('BangleCtrl',function($location, $scope, $http){
	...
	$scope.getVibration = function(){
		...
		$http({
		  method: 'GET',
		  url: 'http://149.202.62.129:8080/person/'+idPerson+'/bracelet'
		}).then(function successCallback(response) {
			...
			$http({
			    method: 'GET',
		  		url: 'http://149.202.62.129:8080/bracelet/'+idBracelet+'/bracelets'
			}).then(function successCallback(response){
